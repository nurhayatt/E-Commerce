        ...
        <div class="bg-content">
           ...
           @foreach (Cart::content() as $cart)
                  <tr>
                    ...
                    <td>{{ $cart->price }}</td>
                    <td>
                        <a href="#" class="btn btn-xs btn-default product-number-decrease" data-id="{{ $cart->rowId }}" data-number="{{ $cart->qty-1 }}" >-</a>
                        <span style="padding: 10px 20px">{{ $cart->qty }}</span>
                        <a href="#" class="btn btn-xs btn-default product-number-increase" data-id="{{ $cart->rowId }}" data-number="{{ $cart->qty-1 }}" >+</a>
                    </td>
                    <td>18.99</td>
                    <td class="text-right">
                      {{ $cart->subtotal }}
